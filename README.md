...
Уровень определяет количество ресурсов сайта, которые доступны пользователю. Чем выше уровень, тем больше угля получает пользователь. Также, высокоуровневым пользователям доступно более активное участие на торговом форуме.  
