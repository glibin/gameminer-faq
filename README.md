...
## Что такое уголь, золото и зачем они нужны, и где их взять?
...
Песочница, это место куда помещаются сомнительные раздачи ключей. Что бы выбраться из песочницы нужно раздать минимум 3 рабочих ключа.
...
Возможно в дальнейшем Steam сделает чтобы игру можно было откреплять от библиотеки но в данный момент это невозможно.
...
Нельзя выйти. Уголь не вернут. Золото - вернут.
...
Если вы выиграли гифт, то он автоматически отправится на Вашу электронную почту (которую Вы указали при регистрации). Если Вы выиграли ключ, то он мгновенно появится у Вас в личных сообщениях.  
...
Инвайты представляют собой код, необходимый для регистрации на сайте. Взять можно тут: http://gameminer.ru/account/invites (генерируются раз в сутки), или тут: http://games-gen.com/GM-invite (сборник инвайтов от старожилов и администрации сайта)
...
Ящики падают за игру в мини-слоты, за создание раздач и за участие в них. Новость об этом: http://gameminer.ru/news/78 В будущем будет введена возможность обмена, и Вы сможете выменять вещи из Вашего Gameminer-инвентаря на ящики/ключи/краски и прочие вещи у других пользователей.

## Где взять ключи к ящикам?

В данный момент их можно только купить. Делается это тут: http://gameminer.ru/inventory/keys (один ключ = 20 золота)

## Как открыть ящик?

Идем в инвентарь: http://gameminer.ru/profile/[ваш_ник]/inventory Выбираем ключ, нажимаем “Использовать”. Далее выбираем понравившийся ящик. Сразу после открытия Вы увидите содержимое ящика. Ящик и ключ после использования исчезают.

## Как передать ящик/предмет другому пользователю?

В данный момент - никак! Трейд обещают добавить в августе/сентябре.

## Что может выпасть из ящиков и зачем оно нужно?

Золото, Уголь, Проклятие, Благословение, Кислота, Смена ника, Смена звания, Краска для ника, Краска для звания, Игра (гифт или ключ).  
...
**Смени ника/звания** - позволяет поменять бесплатно ник или звание.  
...
Да, свое предложение можно оставить в торговом чате. Чтобы попасть туда, нужно нажать кнопку «+» в верхней строке чата и выбрать подходящий чат-рум: Торговля предметами (для продажи/обмена карточек, TF2/Dota2 предметов и предметов из других игр) или Торговля играми (Для продажи/обмена играми).

## Я хочу продать аккаунт Steam/Origin, где и как я могу это сделать?

Продажа аккаунтов осуществляется только на [Черном рынке](http://gameminer.ru/forum/3)  
Кидать ссылки на темы чёрного рынка в чат запрещено.

## Когда будет ближайший FastMiner и что это такое?

Ближайший FastMiner (под номером 3) намечен на конец августа - середину сентября  
Суть эвента - создание множества быстрых (по 10 минут) раздач со стоимостью входа в 1 золото.  
...
К раздачам принимаются только полные игры стоимостью от 10$.  
...
Последние новости всегда вывешиваются на главной странице прямо над вашим ником. Предыдущие новости можно посмотреть в [специальном разделе](http://gameminer.ru/news).
